...
class gsp_cocorahs_loginauth_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',12,['code':("springSecurity.login.header")],-1)
printHtmlPart(5)
...
printHtmlPart(9)
invokeTag('message','g',20,['code':("springSecurity.login.username.label")],-1)
printHtmlPart(10)
invokeTag('message','g',25,['code':("springSecurity.login.password.label")],-1)
printHtmlPart(11)
...
printHtmlPart(14)
invokeTag('message','g',31,['code':("springSecurity.login.remember.me.label")],-1)
printHtmlPart(15)
