...
class gsp_cocorahs_postlist_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('message','g',27,['code':("post.station.label"),'default':("Station")],-1)
printHtmlPart(13)
loop:{
int i = 0
...
printHtmlPart(15)
createTagBody(3, {->
expressionOut.print(fieldValue(bean: postInstance, field: "station"))
})
invokeTag('link','g',35,['action':("show"),'id':(postInstance.id)],3)
printHtmlPart(16)
i++
}
}
printHtmlPart(17)
invokeTag('paginate','g',42,['total':(postInstanceCount ?: 0)],-1)
printHtmlPart(18)
})
